...
const Profile = () => {
  ...
  const refreshAppointments = async () => {
    ...
    try {
      ...
      // Apply this change to both sorting function locations:
      ...
      <View style={styles.appointmentCard}>
        ...
        <View style={styles.statusContainer}>
          <Text style={[
            ...
            appointment.status === 'Confirmed' ? styles.upcomingStatus :
      ...
      {isCancelling && (
        <View style={styles.loadingOverlay_Cancel}>
          <View style={styles.loadingModalContainer_Cancel}>
            ...
            <Text style={styles.loadingMessage_Cancel}>Canceling your appointment...</Text>
          </View>
        </View>
      )}
       <CustomModal
            ...
            >
              <View style={styles.tabTextContainer}>
                ...
                {(tab === 'Pending' || tab === 'Upcoming') && (
                  // Only render the badge if count is greater than zero
                  (tab === 'Pending' && pendingAppointments.length > 0) || 
                  (tab === 'Upcoming' && upcomingAppointments.length > 0) ? (
                    <View style={styles.counterBadge}>
                      <Text style={styles.counterBadgeText}>
                        {tab === 'Pending' ? pendingAppointments.length : upcomingAppointments.length}
                      </Text>
                    </View>
                  ) : null
                )}
...
const styles = StyleSheet.create({
  ...
  counterBadge: {
    ...
    top: -10,
    right: -15,
    backgroundColor: '#FF3B30', // Red circle background
    borderRadius: 10,
    minWidth: 20,
    height: 16,
    justifyContent: 'center',
  ...
  tab: {
    ...
    borderRadius: 22,
    margin: 2,
    position: 'relative', // Add this to support absolute positioning of the badge
  },
  activeTab: {
    backgroundColor: Colors.PRIMARY,
    flex: 0.8,
